...
public class Astro {
	...
	public void setImage(String direccion){
		PhongMaterial aux = new PhongMaterial();
		Image im = new Image(direccion, 8000/ 2d, 4000 / 2d, true, true);
		aux.setDiffuseMap(im);
		figura.setMaterial(aux);
	}
